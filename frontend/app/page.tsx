        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
              Powered by AI and real-time Twitter data. Get instant sentiment analysis, emotion detection, 
              and sarcasm identification for any search query.
            </p>
            ...
            <div className="mt-12 grid grid-cols-3 gap-6 max-w-2xl mx-auto">
              ...
              <div>
                ...
                <div className="text-sm text-slate-600 dark:text-slate-400">Emotions Detected</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-slate-900 dark:text-white">Real-Time</div>
                <div className="text-sm text-slate-600 dark:text-slate-400">Analysis</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Compare results from VADER, RoBERTa, and custom models to get the most accurate sentiment analysis.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Advanced NLP identifies sarcastic tweets that traditional sentiment analysis might miss.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Detect joy, anger, fear, surprise, and sadness with confidence scores for each emotion.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Watch tweets stream in live via WebSocket with instant sentiment classification.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Automatically identify people, places, and organizations mentioned in tweets.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Beautiful visualizations including pie charts, timelines, word clouds, and more.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
      ...
      <footer className="bg-slate-900 text-slate-300 py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center text-sm">
            <p>&copy; 2025 VoxLens. Built with AI-assisted coding for portfolio demonstration.</p>
          </div>
        </div>
      </footer>
    </div>
